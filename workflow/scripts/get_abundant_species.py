...
if __name__ == '__main__':
    fname = '/oak/stanford/groups/dpetrov/swalton/coalescence-pilot-mgx/workflow/out/midas2_output/merge/species/species_relative_abundance.tsv'
    ...
    abundant_species_df.to_csv('/oak/stanford/groups/dpetrov/swalton/coalescence-pilot-mgx/workflow/out/midas2_output/abundant_species.csv')
