...
#AAAA
        ...
        count_parents.to_csv(f'{save_dir}/{subject}_count_parents.csv')
        qlow.to_csv(f'{save_dir}/{subject}_qlow.csv')
        qhigh.to_csv(f'{save_dir}/{subject}_qhigh.csv')
        count_parents.to_csv(f'{save_dir}/{subject}_distinguishing_snps.csv')    
