...
# freq_parent2 = freq_parent2.T
   ...
   # print(freq_parent2)
    return pd.concat([freq_parent1, freq_parent2],axis=1), pd.concat([avg_parent1, avg_parent2],axis=1), pd.concat([frac_zero_parent1, frac_zero_parent2],axis=1), pd.concat([count_parent1, count_parent2],axis=1), distinguishing_snps
...
#AAAA
        ...
        freq_parents, freq_avg_parents, frac_zero_parents, count_parents, distinguishing_snps = get_main(species_dir,args.species, parent_samples, child_samples, freq_filtered_in[parent_samples + child_samples],  depth_filtered_in[parent_samples + child_samples])
