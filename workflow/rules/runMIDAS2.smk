...
rule compute_populationSNVs:
    ...
    shell:
        """
        midas2 merge_snps --samples_list workflow/out/list_of_samples.tsv --species_list {wildcards.species}  --midasdb_name {params.midasdb} --genome_depth 1 --site_depth 1  --site_prev 0.0 --snp_maf 0.01  --advanced --midasdb_dir {params.midasdb_dir} --snp_type any --robust_chunk --genome_coverage 0.5 --num_cores {threads} workflow/out/midas2_output/merge_{wildcards.species}
        """
