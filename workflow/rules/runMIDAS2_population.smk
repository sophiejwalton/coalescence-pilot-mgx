...
rule decompresslz4b: 
    ...
    output:
        snpsDepth="workflow/out/midas2v3b_output/mergevfinal_{species}/snps/{species}/{species}.snps_depth.tsv",
        snpsFreq="workflow/out/midas2v3b_output/mergevfinal_{species}/snps/{species}/{species}.snps_freqs.tsv",
        snpsInfo="workflow/out/midas2v3b_output/mergevfinal_{species}/snps/{species}/{species}.snps_info.tsv",
    shell:
        """
